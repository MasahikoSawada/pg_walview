...
use crate::walmisc::{Reader, fmt_pg_ts, lsn_format};
use crate::walreader::*;
...
impl XlogOp {
    pub fn from_xl_info(info: u8) -> Self {
        match info & XLR_RMGR_INFO_MASK {
            ...
            0xB0 => XlogOp::FPI,
            // 0xC0 and 0xF0 were added after PG18; 0xC0 also had a different
            // meaning in PG 9.5-11, which pg_walview cannot read anyway.
            0xC0 => XlogOp::AssignLsn,
            0xD0 => XlogOp::OverwriteContRecord,
            0xE0 => XlogOp::CheckpointRedo,
            0xF0 => XlogOp::LogicalDecodingStatusChange,
            _ => XlogOp::Unknown,
        }
    }
}
...
impl fmt::Display for XlogOp {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            XlogOp::CheckpointShutdown => write!(f, "CHECKPOINT_SHUTDOWN"),
            ...
            XlogOp::AssignLsn => write!(f, "ASSIGN_LSN"),
            XlogOp::OverwriteContRecord => write!(f, "OVERWRITE_CONTRECORD"),
            XlogOp::CheckpointRedo => write!(f, "CHECKPOINT_REDO"),
            XlogOp::LogicalDecodingStatusChange => write!(f, "LOGICAL_DECODING_STATUS_CHANGE"),
            _ => write!(f, "Unknown"),
        }
    }
}
